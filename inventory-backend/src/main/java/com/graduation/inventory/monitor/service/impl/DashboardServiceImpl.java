...
public class DashboardServiceImpl implements DashboardService {
    ...
    public OverviewVo getOverview() {
        ...
        BigDecimal totalStock = stockList.stream()
        ...
        BigDecimal todayInbound = inboundRecords.stream()
        ...
        BigDecimal todayOutbound = outboundRecords.stream()
                .map(StockRecord::getChangeQty)
                .filter(q -> q != null)
                .map(BigDecimal::abs)
                .reduce(BigDecimal.ZERO, BigDecimal::add);
    ...
    public List<CategoryRatioVo> getCategoryStockRatio() {
        ...
        Map<Long, Long> spuCategoryMap = spuList.stream()
                .collect(Collectors.toMap(BaseProductSpu::getId, BaseProductSpu::getCategoryId));
